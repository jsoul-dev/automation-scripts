...
echo =====================================================
echo.
powershell -Command "Write-Host ' WARNING: If you have any existing Office ' -ForegroundColor Yellow -NoNewline; Write-Host '' -ForegroundColor Yellow"
powershell -Command "Write-Host ' installation, it will be AUTOMATICALLY ' -ForegroundColor Yellow -NoNewline; Write-Host '' -ForegroundColor Yellow"
powershell -Command "Write-Host ' UNINSTALLED and replaced with this one. ' -ForegroundColor Yellow"
echo.
powershell -Command "Write-Host ' NOTE: To ADD apps (e.g. Teams) to an existing ' -ForegroundColor Cyan"
powershell -Command "Write-Host ' Office installation (e.g. Word, Excel, PPT), ' -ForegroundColor Cyan"
powershell -Command "Write-Host ' you MUST include ALL apps you want to keep. ' -ForegroundColor Cyan"
powershell -Command "Write-Host ' Apps not selected will be UNINSTALLED by ODT. ' -ForegroundColor Cyan"
echo.
...
echo   ^<Extend CreateShortcuts="true" /^>
echo ^</Configuration^>
) > "C:\Office\Configuration.xml"
