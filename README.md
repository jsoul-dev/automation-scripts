...
- [⬇️](https://github.com/jsoul-dev/automation-scripts/releases/latest/download/manga-translator.py) **[Manga Translator](./manga-translator/)**: An automated Python script that batch-translates raw manga pages from Japanese to English using the MangaTranslate API.
...
- [⬇️](https://github.com/jsoul-dev/automation-scripts/releases/latest/download/mouse-mode.ahk) **[Mouse Mode](./mouse-mode/)**: A lightweight system tray utility that allows you to instantly switch the behavior of your mouse's side buttons.
...
- [⬇️](https://github.com/jsoul-dev/automation-scripts/releases/latest/download/wifi-pass-viewer.bat) **[WiFi Pass Viewer](./wifi-pass-viewer/)**: A lightweight, terminal-based batch script that extracts and views saved Wi-Fi network passwords on Windows.
